...
CC = gcc -std=gnu99
CFLAGS = -g -O2 -fstack-protector --param=ssp-buffer-size=4 -Wformat -Wformat-security -Werror=format-security -D_FORTIFY_SOURCE=2 -g $(LTO)
CPICFLAGS = -fpic
CPPFLAGS = -Wformat=0
CXX = g++
  CXXCPP = $(CXX) -E
CXXFLAGS = -g -O2 -fstack-protector --param=ssp-buffer-size=4 -Wformat -Wformat-security -Werror=format-security -D_FORTIFY_SOURCE=2 -g $(LTO)
CXXPICFLAGS = -fpic
CXX1X = g++
  CXX1XFLAGS = -g -O2 -fstack-protector --param=ssp-buffer-size=4 -Wformat -Wformat-security -Werror=format-security -D_FORTIFY_SOURCE=2 -g
CXX1XPICFLAGS = -fpic
CXX1XSTD =  -std=c++0x
DYLIB_EXT = .so
DYLIB_LD = $(CC)
...
TCLTK_CPPFLAGS = -I/usr/include/tcl8.5 -I/usr/include/tcl8.5 
TCLTK_LIBS = -L/usr/lib -ltcl8.5 -L/usr/lib -ltk8.5 -lX11 -lXss -lXext
